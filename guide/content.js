        ...
        items: [
          {
            ...
            text: "Feasible means that the analysed configuration satisfies the implemented energy, state-of-charge, timing and charging constraints. Infeasible means that one or more assumptions or design choices must be revised.",
          },
          {
  ...
  de: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { title: "Machbarkeitsurteil", text: "Machbar bedeutet, dass die analysierte Konfiguration die implementierten Energie-, Ladezustands-, Zeit- und Ladebedingungen erfüllt. Nicht machbar bedeutet, dass Annahmen oder Designentscheidungen geändert werden müssen." },
  ...
  fr: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { title: "Verdict de faisabilité", text: "Faisable signifie que la configuration respecte les contraintes implémentées d’énergie, d’état de charge, de temps et de recharge. Infaisable signifie qu’une hypothèse ou un choix de conception doit être revu." },
  ...
  it: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { title: "Verdetto di fattibilità", text: "Fattibile significa che la configurazione rispetta i vincoli implementati di energia, stato di carica, tempo e ricarica. Non fattibile significa che occorre rivedere ipotesi o scelte progettuali." },
